...
export default function Dashboard() {
  ...
  // ✏️ Commencer à éditer un RDV
  const startEditRdv = (r) => {
    setEditingRdvId(r.id)
    setEditedRdv({
      date: r.date,
      heure: r.heure,
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        {/* Liste des clients */}
        <section className="bg-white rounded-2xl shadow-md p-6 space-y-4 transition hover:shadow-lg">
